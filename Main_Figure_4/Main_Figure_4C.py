...
def TPT_bt(A,B,tech):
    filenames = glob.glob('../MSM_obj/CB2_assym_bt_80_*_msm.pkl') #bootstrapped MSM object with 80% of the data
    timescale = []
...
if __name__=='__main__':
    ...
    macrostate_names = {'TM45':'A_{CB2}^{Mem}','TM56':'I1_{CB2}^{TM56}','TM17':'I_{CB2}^{TM17}','B1':'B_{CB2}^{Pro}','Bulk':'U_{CB2}^{Mem}','B2':'I2_{CB2}^{TM56}'}
